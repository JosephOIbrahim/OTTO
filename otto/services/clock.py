...
[He2025]: Time boundaries are fixed constants.  Classification
...
# [He2025]: Fixed constants, deterministic classification.
...
class ClockService:
    ...
    def get_signals(self) -> list[CategoricalSignal]:
        ...
        # [He2025]: Sort by (category, value) for determinism
