...
for [He2025] determinism — evaluation order is fixed and reproducible.
...
# ---------------------------------------------------------------------------
# Master pattern list — SORTED by signal_type.name for [He2025]
# ---------------------------------------------------------------------------
...
# [He2025] CRITICAL: Sort by signal_type.name for deterministic evaluation order.
