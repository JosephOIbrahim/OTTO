...
the input text in a fixed order (sorted by signal_type.name per [He2025])
...
from otto.core.prism.patterns import PATTERNS
...
class PRISMDetector:
    ...
    def detect(self, text: str) -> list[Signal]:
        ...
        # Build Signal objects — iterate in sorted order for [He2025]
        signals: list[Signal] = []
