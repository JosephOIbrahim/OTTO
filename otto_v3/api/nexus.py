...
Expert prompt selection uses sorted iteration over voice
...
from otto_v3.core.prism.signals import Signal
from otto_v3.core.experts.base import ExpertSelection
from otto_v3.core.experts.router import NEXUSRouter
from otto_v3.api.client import OTTOClient, APIResponse
from otto_v3.api.effort import EffortController, EffortLevel
...
#
# Dict is constructed from sorted items for deterministic
# iteration order.
...
def build_system_prompt(selection: ExpertSelection) -> str:
    ...
    Expert names are already sorted in ExpertSelection.
